...
if (temperature >= 80 && rain){
  ...
  console.log("Come up with your own clothing suggestions based on those temperature")
}
////////// PROBLEM 5 //////////
...
while(z > 0){
  ...
  countdown = z; // assign the value of z to countdown every loop iteration
  while(countdown > 0){
