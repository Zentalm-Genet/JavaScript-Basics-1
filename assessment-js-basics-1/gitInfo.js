...
const gitDefinition = "Git is a version control system that allows developers to track changes in their code."
...
const gitInitDefinition = "git init command is to initialize the new working environment or a new git repository to work on a new project."
...
const gitCommitDefinition = "The git commit command is used to commit the modified files which are available in the staging area."
...
const gitPushDefinition = " The git push command allows you to send (or push) the commits from your local branch in your local Git repository to the remote repository."
