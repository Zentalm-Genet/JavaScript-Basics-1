...
let lastItemRemoved = arr.pop(arr.length-1);
console.log(arr);
////////// PROBLEM 3 //////////
...
for (let i = 0; i < family.length; i++){
  console.log(family[i]) // i is represent index of array
}
...
let someNum = myFavoriteNumbers[4]; // becuase index is start from 0.
...
console.log("There are not enough elements in this array")
  ...
  someNum = myFavoriteNumbers[6]; // becuase index start from 0 
}
